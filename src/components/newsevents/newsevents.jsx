...
export default function NewsEvents() {
  return (
    <PageBodySideMenu name={'NewsEvents'}>
      ...
      <p>
        <b>The miracle?</b> The Village Library&apos;s Board and volunteers keep
        the place running through thick and thin. The Village Library exists
        because of the extraordinary effort of over 75 dedicated volunteers who
        devote their time and talents daily. The success of this venture for
        thirty years is the result of dedication and effort of many people who
        carry on in spite of the speed bumps.
      </p>
      <p>
        <b>ACCOMPLISHMENTS</b>
      </p>
      ...
      <p className='p_accomplishments'>
        ...
        publications, delightful fliers and posters, and the excellent monthly
        volunteer newsletter. She is leaving her position as PIO but will
        continue as an at-large member of the Board and the new Browsing
